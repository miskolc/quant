...
df = pd.DataFrame( index=df_m.index,columns=['601398', '601288', 'date'])


df["601288"] = df_g["close"]
...
#reg.fit(df["601288"].values.reshape(-1, 1), df["601398"].values.reshape(-1, 1))
#x = reg.coef_[0][0]
