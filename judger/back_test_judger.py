...
class DailyBackTestJudger():
    ...
    def hs_300_base_profit(self):
        hs_df = k_data_dao.get_k_data('SH.000300', start=self.context.start, end=self.context.end, futu_quote_ctx=self.context.futu_quote_ctx)
...
if __name__ == '__main__':
    dbt = DailyBackTestJudger(start='2018-01-02', end=None, base_capital=50000)
    dbt.hs_300_base_profit()

    dbt.context.futu_quote_ctx.close();
